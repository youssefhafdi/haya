...
export default function MotoDevis() {
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    formData.append('subject', 'Demande de devis Moto');
      ...
      <div className="max-w-4xl mx-auto px-6 py-28">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20">
          ...
          <form ref={formRef} onSubmit={onSubmit} className="mt-8">
            ...
            <input type="hidden" name="from_name" value="Assurance Moto" />
            <input type="hidden" name="form_name" value="Assurance Moto" />
            <input type="hidden" name="from_page" value="/assurance-moto" />

            {/* Étape 1: Infos deux-roues */}
            <div data-step="1" className={`grid grid-cols-1 md:grid-cols-2 gap-6 ${step === 1 ? '' : 'hidden'}`}>
              ...
              <div>
                <label htmlFor="cylindree" className="block text-sm font-medium text-white mb-2">Cylindrée</label>
                <Select value={cylindree} onValueChange={setCylindree} required>
                  ...
                  <SelectContent className="bg-gray-900 border-white/20">
                    <SelectItem value="<50cc" className="text-white hover:bg-white/10 focus:bg-white/10">Moins de 50cc</SelectItem>
                    <SelectItem value="50-125cc" className="text-white hover:bg-white/10 focus:bg-white/10">50 à 125cc</SelectItem>
                    <SelectItem value=">125cc" className="text-white hover:bg-white/10 focus:bg-white/10">Plus de 125cc</SelectItem>
                  </SelectContent>
                </Select>
                <input type="hidden" name="Cylindrée" value={cylindree} />
              </div>
            </div>
            ...
            <div data-step="2" className={`grid grid-cols-1 md:grid-cols-2 gap-6 ${step === 2 ? '' : 'hidden'}`}>
              ...
              <div>
                <label htmlFor="datePermis" className="block text-sm font-medium text-white mb-2">Date d'obtention du permis A/A2/AM</label>
